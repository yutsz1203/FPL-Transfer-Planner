...
def get_next_n_gameweek(fixtures, player_df, team_df, type, gw, side_adjustment=True, n=5):
    ...
    for player in players:
        ...
        opponents = []
        total_team_Oi, total_team_Di, total_opponents_Oi, total_opponents_Di, total_player_xGI, total_player_xGc, projected_GI, projected_Gc = 0, 0, 0, 0, 0, 0, 0, 0
        for oppo in nextn_gws:
            ...
            if side_adjustment:
                if side == "H":
                    ...
                    total_team_Oi += team_df[team_df["team"] == team_name]["h_Oi"].values[0]
                    total_team_Di += team_df[team_df["team"] == team_name]["h_Di"].values[0]
                    total_opponents_Oi += team_df[team_df["team"] == opponent]["a_Oi"].values[0]
                    total_opponents_Di += team_df[team_df["team"] == opponent]["a_Di"].values[0]
                    projected_GI += round(player["h_xGI/Game"] * team_df[team_df["team"] == opponent]["a_Di"].values[0], 2)
                    projected_Gc += round(player["h_xGc/Game"] * team_df[team_df["team"] == opponent]["a_Oi"].values[0], 2)
                else:
                    total_player_xGI += player["a_xGI/Game"]
                    total_player_xGc += player["a_xGc/Game"]
                    total_team_Oi += team_df[team_df["team"] == team_name]["a_Oi"].values[0]
                    total_team_Di += team_df[team_df["team"] == team_name]["a_Di"].values[0]
                    total_opponents_Oi += team_df[team_df["team"] == opponent]["h_Oi"].values[0]
                    total_opponents_Di += team_df[team_df["team"] == opponent]["h_Di"].values[0]
                    projected_GI += round(player["a_xGI/Game"] * team_df[team_df["team"] == opponent]["h_Di"].values[0], 2)
                    projected_Gc += round(player["a_xGc/Game"] * team_df[team_df["team"] == opponent]["h_Oi"].values[0], 2)
            else:
                ...
                total_opponents_Oi += team_df[team_df["team"] == opponent]["Oi"].values[0]
                total_opponents_Di += team_df[team_df["team"] == opponent]["Di"].values[0]
                projected_GI += round(player["xGI/Game"] * team_df[team_df["team"] == opponent]["Di"].values[0], 2)
                projected_Gc += round(player["xGc/Game"] * team_df[team_df["team"] == opponent]["Oi"].values[0], 2)
    ...
    next_n_gameweek_df = next_n_gameweek_df.drop(columns=["xGI/Game", "xGc/Game", "h_xGI/Game", "h_xGc/Game", "a_xGI/Game", "a_xGc/Game"])
...
if __name__ == "__main__":
    ...
    # current season strengths
    get_next_n_gameweek(fixtures, player_current_season, team_current_season, "currentseason", gw, False)
